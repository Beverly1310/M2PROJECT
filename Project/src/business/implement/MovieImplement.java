                        ...
                        if (choiceMovie >= 1 && choiceMovie <= moviesList.size()) {
                            if (watch(choiceMovie)) {//xem phim
                                ...
                                System.out.println("1. Để lại đánh giá của bạn\n" +
                                        ...
                                        "3. Thoát\n" +
                                        "Nhập lựa chọn");
                                byte commentOrNot = InputMethods.getByte();// chọn để lại đánh giá, thêm vào favorite list  hay không
                                switch (commentOrNot) {
                                    case 1:
                                        leaveComment(moviesList.get(choiceMovie - 1));
                                        return;
                                    case 2:
                                        addToFavoriteList(moviesList.get(choiceMovie - 1));
                                        return;
                                    case 3:
                                        return;
                                    default:
                        ...
                        if (watch(indexMovie + 1)) {
                            ...
                            switch (commentOrNot) {
                                case 1:
                                    ...
                                    return;
                                case 2:
                                    addToFavoriteList(moviesList.get(indexMovie));
                                    return;
                                case 3:
                                    return;
                                default:
...
//hàm xem phim
    private static boolean watch(int choiceMovie) {
        System.out.println("\u001B[32mĐang xem phim: \u001B[0m" + moviesList.get(choiceMovie - 1).getMovieName());
